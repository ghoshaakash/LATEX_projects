...
\begin{center}
    ...
    %Curve Lines [id:da11399484730231146] 
    \draw    (41.5,151) .. controls (42,66.75) and (190,103.75) .. (189,132.75) ;
    %Curve Lines [id:da9481136710420994] 
    \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=1.5]    (80.5,101.75) .. controls (127,91.25) and (153.5,108.25) .. (162.5,110.75) ;
    %Straight Lines [id:da22787375387757003] 
    \draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ]   (80.5,101.75) -- (162.5,110.75) ;
    
    % Text Node
    \draw (113.5,77.4) node [anchor=north west][inner sep=0.75pt]    {$s$};
    % Text Node
    \draw (113.5,108.4) node [anchor=north west][inner sep=0.75pt]    {$d$};
    % Text Node
    \draw (71,82.4) node [anchor=north west][inner sep=0.75pt]    {$P$};
    % Text Node
    \draw (162.5,92.9) node [anchor=north west][inner sep=0.75pt]    {$Q$};
...
We can fix $P$ as $\gamma(0)$, $\gamma'(s)=1$ by a suitable reparameterization. Then
\begin{align*}
    d^2=||\gamma(s)-\gamma(0)||^2\\
    s=\int_0^s||\gamma'(u)||du
\end{align*}
\begin{theorem}
    If $\gamma$ is $C^3$ then:
    \begin{enumerate}
        \item $\lim_{s\to0}\frac{d}{s}=1$
        \item $\lim_{s\to0}\frac{d-s}{s^3}=\frac{-1}{24}||\gamma''(0)||^2$
    \end{enumerate}
\end{theorem}
\begin{proof}
